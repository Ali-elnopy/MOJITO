...
function Menu() {
    ...
    const totalNumedOfCocktails = allCocktails.length;

    const goToSlide = (index) =>{
        const newIndex = (index +totalNumedOfCocktails) % totalNumedOfCocktails
        setCurrentIndex(newIndex)
    }

    const getCocktailAt = (indexOffset)=>{
        return allCocktails[(currentIndex + indexOffset + totalNumedOfCocktails) % totalNumedOfCocktails]
    }

    const currentCocktail = getCocktailAt(0);
    const pervCocktail = getCocktailAt(-1);
